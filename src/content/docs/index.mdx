...
hero:
  ...
  actions:
    - text: Tracker Blog
      ...
      icon: right-arrow
      variant: primary
    - text: Projects we're working on
      link: /projects/
      icon: seti:plan
      variant: secondary
---
...
- I want something that has everything I need right now but simpler, and as future-proof as possible; and I want far less drama: a great, truly open-source community, and my content in Markdown and right there in the repo! Content collection meta info defined in JSON and YAML front matter, content maintained in Markdown in the filesystem. Or database, or server-based API (coming soon!): yes, [Astro](https://astro.build).
