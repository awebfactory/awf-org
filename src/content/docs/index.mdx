...
- I want something simple and long-lasting: my content in Markdown! Content collections in defined in JSON and maintained in Markdown in the filesystem. Or database, or server-based API (coming soon!): yes, Astro.
- And for this project-based project (yep, I want it to be self-documented right here as just another project)? Let's customize the documentation website template Starlight (made in Astro!) in record time!
